...
<!-- The page's own `<main>`, the per-page convention of the `(auth)` pages; see `../+layout.svelte`. -->
<main class="flex flex-col gap-6">
	...
	<!--
		...
		visually hidden rather than shown twice. `post-preview.svelte` already renders the same title
		as its own `<h3>`, styled the way this page wants it to look.
	-->
